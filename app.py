...
tabs = st.tabs(["📥 1. Ingest Subject Books", "📝 2. Assemble Test Paper", "📚 3. PCM Question Bank", "🗓️ 4. Daily Routine & Reminders"])
...
# ==========================================
# TAB 4: DAILY ROUTINE & TASK REMINDERS
# ==========================================
with tabs[3]:
    st.subheader("🗓️ Daily Routine & Task Reminders")
    st.caption(
    ...
    if not day_tasks:
        ...
        st.caption(
            ...
            "ke baad bhi reminder chahiye, to email/SMS/push service integrate karna padega — bata dena, wo bhi set kar dunga."
        )